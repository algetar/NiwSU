...
use app\components\tgtools\speller\ItemRepresentation;
use app\components\tgtools\speller\MoneyRepresentation;
use app\components\tgtools\speller\StackRepresentation;
use app\components\tgtools\speller\ItemTitles;
use app\components\tgtools\speller\ItemGroupTitles;
use app\components\tgtools\speller\DigitNameTitles;
use app\components\tgtools\speller\DecimalTitles;
 ...
 * 
 * @property \app\components\tgtools\speller\ItemTitles $titles списки исчисляемых
 * @property \app\components\tgtools\speller\ItemGroupTitles $groups списки групп исчисляемых
 * @property \app\components\tgtools\speller\DecimalTitles $decimals список наименований разрядов дробной части числа
 * @property int $cutoff сокращение наименования исчисляемого
 * @property \app\components\tgtools\speller\DigitNameTitles $currentItem
 * 
...
class Items extends \yii\base\Object {
    ...
    protected $_digits;
    /**
     * @var \app\components\tgtools\speller\ItemTitles
     */
    protected $_titles;
    /**
     * Наименования разрядов дробной части числа
     * @var \app\components\tgtools\speller\DecimalTitles
     */
    protected $_decimals;
    /**
     * @var \app\components\tgtools\speller\ItemGroupTitles
     */
    protected $_groups;
    ...
    /**
     * @return \app\components\tgtools\speller\ItemGroupTitles
     */
    ...
    /**
     * @return \app\components\tgtools\speller\ItemTitles
     */
     ...
     * @return \app\components\tgtools\speller\DecimalTitles 
     */
     ...
     * @param int $id
     * @return \app\components\tgtools\speller\DigitNameTitles
     */
